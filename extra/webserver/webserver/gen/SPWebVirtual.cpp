...
static VirtualFile
_virtual_js_shell_js = VirtualFile::add("/virtual/js/shell.js", R"VirtualFile(var KawaiJson = function() {
	var init = false;
...
static VirtualFile
_virtual_css_kawaiJson_css = VirtualFile::add("/virtual/css/kawaiJson.css", R"VirtualFile(ul {
...
static VirtualFile
_virtual_css_md_css = VirtualFile::add("/virtual/css/md.css", R"VirtualFile(.docs {
	padding: 12px 0;
}
...
static VirtualFile
_virtual_css_style_css = VirtualFile::add("/virtual/css/style.css", R"VirtualFile(html {
	font-size: 18px;
}
...
static VirtualFile
_virtual_html_components_pug = VirtualFile::add("/virtual/html/components.pug", R"VirtualFile(mixin components
	p.components
		if root
...
static VirtualFile
_virtual_html_docs_pug = VirtualFile::add("/virtual/html/docs.pug", R"VirtualFile(include virtual://html/header.pug
...
static VirtualFile
_virtual_html_errors_pug = VirtualFile::add("/virtual/html/errors.pug", R"VirtualFile(include virtual://html/header.pug
...
static VirtualFile
_virtual_html_errors_unauthorized_pug = VirtualFile::add("/virtual/html/errors_unauthorized.pug", R"VirtualFile(include virtual://html/header.pug
...
static VirtualFile
_virtual_html_handlers_pug = VirtualFile::add("/virtual/html/handlers.pug", R"VirtualFile(include virtual://html/components.pug
...
static VirtualFile
_virtual_html_header_pug = VirtualFile::add("/virtual/html/header.pug", R"VirtualFile(mixin header(name)
	.title
		h1
			span.name= name
...
static VirtualFile
_virtual_html_reports_pug = VirtualFile::add("/virtual/html/reports.pug", R"VirtualFile(include virtual://html/components.pug
include virtual://html/header.pug
...
static VirtualFile
_virtual_html_server_pug = VirtualFile::add("/virtual/html/server.pug", R"VirtualFile(include virtual://html/components.pug
include virtual://html/header.pug
